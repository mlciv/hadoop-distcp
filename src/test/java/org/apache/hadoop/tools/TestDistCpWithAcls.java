...
public class TestDistCpWithAcls {
  ...
  public void testPreserveAcls() throws Exception {
    ...
    assertRunDistCpByChunk(DistCpConstants.SUCCESS, "/dstPreserveAcls");
  ...
  public void testAclsNotEnabled() throws Exception {
    try {
      ...
      assertRunDistCpByChunk(DistCpConstants.ACLS_NOT_SUPPORTED, "/dstAclsNotEnabled");
    } finally {
      restart(true);
    }
  }
  ...
  public void testAclsNotImplemented() throws Exception {
    ...
    assertRunDistCpByChunk(DistCpConstants.ACLS_NOT_SUPPORTED,
            "stubfs://dstAclsNotImplemented");
  }
  ...
  private static void assertRunDistCpByChunk(int exitCode, String dst)
          throws Exception {
    DistCp distCp = new DistCp(conf, null);
    assertEquals(exitCode, ToolRunner.run(
            conf, distCp, new String[] {"-bychunk", "-pa", "/src", dst }));
  }
