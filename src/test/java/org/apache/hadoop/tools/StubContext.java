...
public class StubContext<T extends CopyListingFileStatus> {

  private StubStatusReporter reporter = new StubStatusReporter();
  private RecordReader<Text, T> reader;
  private StubInMemoryWriter writer = new StubInMemoryWriter();
  private Mapper<Text, T, Text, Text>.Context mapperContext;

  public StubContext(Configuration conf,
      RecordReader<Text, T> reader, int taskId)
      throws IOException, InterruptedException {

    WrappedMapper<Text, T, Text, Text> wrappedMapper
            = new WrappedMapper<Text, T, Text, Text>();

    MapContextImpl<Text, T, Text, Text> contextImpl
            = new MapContextImpl<Text, T, Text, Text>(conf,
  ...
  public Mapper<Text, T, Text, Text>.Context getContext() {
  ...
  public RecordReader<Text, T> getReader() {
    return reader;
  }
