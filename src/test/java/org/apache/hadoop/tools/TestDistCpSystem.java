...
public class TestDistCpSystem extends TestCase {
  ...
  private void testPreserveUserHelperByChunk(
          FileEntry[] srcEntries,
          FileEntry[] dstEntries,
          boolean createSrcDir,
          boolean createTgtDir,
    ...
    try {
      ...
      String[] args = update? new String[]{"-bychunk","-pu", "-update", nnUri+testSrc,
              nnUri+testDst} : new String[]{"-bychunk","-pu", nnUri+testSrc, nnUri+testDst};
  ...
  public void testPreserveUseNonEmptyDir() throws Exception {
    ...
    testPreserveUserHelperByChunk(srcfiles, srcfiles, false, true, false);
    testPreserveUserHelperByChunk(srcfiles, dstfiles, false, false, false);
  }
  ...
  public void testPreserveUserNonEmptyDirWithUpdate() throws Exception {
    ...
    testPreserveUserHelperByChunk(srcfiles, dstfiles, true, true, true);
  }
