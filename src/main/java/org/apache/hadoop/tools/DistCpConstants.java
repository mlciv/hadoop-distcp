...
public class DistCpConstants {
  ...
  public static final int DEFAULT_BLOCKS_PER_CHUNK = 1;
  ...
  public static final String CONF_LABEL_BLOCKS_PER_CHUNK = "distcp.copy.blocks.perchunk";
  ...
  public static final String CONF_LABEL_COPY_BY_CHUNK = "distcp.copy.bychunk";

  public static final String CONF_LABEL_ERROR_NOTE = "distcp.copy.errornote";

  public static final String CONF_LABEL_MAX_THREADS = "distcp.map.max.threads";
  ...
  /* If input is based -f <<source listing>>, file containing the src paths */
  public static final String CONF_LABEL_CHECK_LISTING_FILE_PATH = "distcp.check.listing.file.path";
