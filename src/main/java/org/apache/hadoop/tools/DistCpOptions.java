...
public class DistCpOptions {
  ...
  private boolean byChunk = false;

  private int maxMaps = DistCpConstants.DEFAULT_MAPS;
  private int maxThreads = DistCpConstants.DEFAULT_THREADS;
  ...
  public DistCpOptions(DistCpOptions that) {
    if (this != that && that != null) {
      ...
      this.byChunk = that.getByChunk();
      this.maxThreads = that.getMaxThreads();
    }
  }
  ...
  public EnumSet<FileAttribute> getPreserveStatus() {
    return preserveStatus;
  }

  public void setPreserveStatus(String preserveStr){
    this.preserveStatus = DistCpUtils.unpackAttributes(preserveStr);
  }
  /**
  ...
  /**
   * Setter for byChunk option
   * @param byChunk
   */
  public void setByChunk(boolean byChunk) {
    this.byChunk = byChunk;
  }

  /**
   * Getter for byChunk option
   * @return
   */
  public boolean getByChunk() {
    return byChunk;
  }

  /**
   * Getter for -t maxthreads option
   * @return
   */
  ...
  /**
   * Setter for -t maxThreads option
   * @param maxThreads
   */
  ...
  public void validate(DistCpOptionSwitch option, boolean value) {
    ...
    boolean byChunk = (option == DistCpOptionSwitch.BY_CHUNK ? value : this.byChunk);
   ...
   * TODO: not add WorkPath to configuration
   *
  ...
  public void appendToConf(Configuration conf) {
    ...
    DistCpOptionSwitch.addToConf(conf,DistCpOptionSwitch.BY_CHUNK, String.valueOf(byChunk));
    DistCpOptionSwitch.addToConf(conf,DistCpOptionSwitch.MAX_MAPS, String.valueOf(maxMaps));
    DistCpOptionSwitch.addToConf(conf,DistCpOptionSwitch.MAX_THREADS,String.valueOf(maxThreads));
  }
