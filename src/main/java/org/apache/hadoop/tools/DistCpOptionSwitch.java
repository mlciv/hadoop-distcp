...
public enum DistCpOptionSwitch {
   ...
   * as equally as possible among these maps
   */
  MAX_THREADS(DistCpConstants.CONF_LABEL_MAX_THREADS,
          new Option("t", true, "Max number of concurrent threads to use for copy")),
  ...
  BY_CHUNK(DistCpConstants.CONF_LABEL_COPY_BY_CHUNK,
          new Option("bychunk",false,"Copy file by chunks"));
