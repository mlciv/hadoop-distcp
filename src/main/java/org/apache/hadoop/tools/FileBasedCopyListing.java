...
public class FileBasedCopyListing extends CopyListing {
  ...
  @Override
  public void buildListing(Path pathToListFile,
                           DistCpOptions options) throws IOException {
    validatePaths(options);
    doBuildListing(pathToListFile, options);
    validateFinalListing(pathToListFile, options);

    //TODO: for chunk and chunkParallel
    postBuildListing(pathToListFile,pathToListFile,options);
  }
  ...
  @Override
  protected void validateFinalListing(Path path,DistCpOptions options){
  }

  @Override
  protected void postBuildListing(Path pathToCheckFile,Path pathToListFile,DistCpOptions options){
  }
  ...
  public void doBuildListing(Path pathToListFile, DistCpOptions options) throws IOException {
    ...
    options.setSourcePaths(newOption.getSourcePaths());
  ...
  @Override
  protected void setBytesToCopy(long bytesToCopy){
    globbedListing.setBytesToCopy(bytesToCopy);
  }

  @Override
  protected void setNumberOfPaths(long paths){
    globbedListing.setBytesToCopy(paths);
  }
